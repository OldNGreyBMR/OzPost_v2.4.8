<?php // Zencart v1.3.7, -> v1.5.7d    Note: The "// Zencart" is used as an initial test for a valid update file (only needs to read a few chars)
// BMH 2020-11 define
/*
  ...
  Copyright (c) 2020 Cronomic
    ...
    $Id: ozpost.php V4.2.8  2022-09-28
        Updates for Zencart 1.5.6c; 157d
        Updates for PHP 7.4; PHP 8.0; PHP 8.1
*/
// BMH 2020-11-12
...
// BMH 2022-09-26   ln287 index postcode; ln254 index carrier
...
if (!defined('REMOTE-HOST')) define('REMOTE_HOST', '');
...
class ozpost extends base
{
	...
	public function quote($method = '')
	{
        ...
        // // //
			...
			$this->quotes = array(
				'id' => $this->code,        // "ozpost"
				'module' => $temp['carrier'] ?? '',  // TNT, Australia Post, FastWay etc // BMH index carrier
				'methods' => array(
					array(
